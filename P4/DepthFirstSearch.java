...
public class DepthFirstSearch {
     ...
     */
    public DepthFirstSearch(SimpleGraph G, int s, int x, int y) {
    ...
    private void dfs(SimpleGraph G, int v, int x, int y) {
        // System.out.println("  Var values: " + v + " " + x + " " + y);
        if(v != x && v != y){
            count++;
            marked[v] = true;
